...
from main_source.models.NTS import resnet
import numpy as np
from main_source.models.NTS.anchors import generate_default_anchor_maps, hard_nms
...
class attention_net(nn.Module):
    def __init__(self, topN=4, num_classes = 196, cat_num = 4, input_shape = (448,448)):
        ...
        _, edge_anchors, _ = generate_default_anchor_maps(input_shape= input_shape)
        self.pad_side = 224
